...
BuffMate is a Perl utility that assists in the process of creating buffer overflow exploits. The entire process from fuzzing to exploitation is streamlined into one tool. It is designed around Perl and its core modules only. No external dependencies are required, making BuffMate a lightweight and mobile solution.
